...
#'
#' `plot_regfeat` downloads regulatory features found between `startpos` and `endpos` of the chromosome `chr` from the chosen ensemble dataset and plots the data as a segment plot.
...
#'
#' @return Segment plot of regulatory features with colored annotation of a variable methylated region, if provided.
#' @export
#'
