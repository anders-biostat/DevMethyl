...
#'
#' @return Arrow plot of genes including colored annotations of the genomic features. Arrows directed to the left are minus strand genes and arrows directed to the right are plus strand genes.
#' @export
#'
