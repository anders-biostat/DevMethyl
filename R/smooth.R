#' Apply Gaussian filter to temporal methylation data from scNMT-seq
#'
...
#' @param trange Vector containing minimum and maximum of the pseudotimes.
#'
