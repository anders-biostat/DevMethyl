...
## 4.1 CpG islands
With `plot_cpgislands` you'll download and plot the CpG islands within your ROI of the the genome version of your choice. The information is downlaoded from the UCSC Genome Browser https://genome.ucsc.edu/cgi-bin/hgTables.
```{r plot_CpGi, fig.width=7}
plot_cpgislands("mm39", chr, rstart, rend)
```
...
plot_all("mouse", "mm39", sp, spAcc, meta, header, header_acc, regpath, genepath, hx, ht, chr, rstart, rend, startVR, endVR)
```
